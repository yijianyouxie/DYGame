...
async def debug_find_objects():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        try:
            ...
            for search_term, search_method in test_searches:
                print(f"\n   🔍 测试：search_term='{search_term}', search_method='{search_method}'")
            ...
            test_cases = [
                ("Main Camera", "exact"),
                ("Main Camera", "contains"),
                ("Camera", "contains"),
                ("Directional Light", "exact"),
                ("Light", "contains"),
                ("Canvas", "exact"),
                ("Button", "exact"),
            ]
            ...
            # ========== 4. 使用 by_path 直接访问已知对象 ==========
            print("\n📋 步骤 4: 使用 by_path 直接访问已知对象...")
