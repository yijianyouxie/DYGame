...
# -*- coding: utf-8 -*-
"""
设置LeaderboardButton大小为Button的一半
根据之前复制按钮时的设置，Button大小为160x80，所以一半应该是80x40
"""
import asyncio
import aiohttp
import json
...
async def set_leaderboard_size():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        init_msg = {
            ...
            'params': {
                ...
                'capabilities': {},
                'clientInfo': {'name': 'set-size', 'version': '1.0.0'}
            }
        }
        ...
        # 修改LeaderboardButton大小为Button的一半 (假设Button是160x80，所以一半是80x40)
        half_size_x = 80
        half_size_y = 40
        
        print(f"\n设置LeaderboardButton大小为: {half_size_x} x {half_size_y}")
...
asyncio.run(set_leaderboard_size())
