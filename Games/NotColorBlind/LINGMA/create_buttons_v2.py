...
async def create_button(session, url, headers, button_name, button_text):
    ...
    # 检查按钮是否已存在
    print(f"[1/8] 检查{button_name}是否已存在...")
    ...
    if existing_ids:
        print(f"找到 {len(existing_ids)} 个{button_name}，删除旧的...")
...
async def main():
    ...
    print("="*70)
    print("创建LevelScene返回按钮和ResultScene排行榜按钮")
    print("="*70)
